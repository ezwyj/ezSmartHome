define(['common', 'plugins', 'datepicker'], function ($) {
    ...
    $('#exportLog').on('click', function () {
        $(this).attr('href', rootUrl + 'System/ExportLog?type=' + $('[name="Type"]').val() + '&logOperator=' + ($('[name="Operator"]').data('data') == undefined ? "" : $('[name="Operator"]').data('data').Badge) + '&startTime=' + $('[name="StartTime"]').val() + '&endTime=' + $('[name="EndTime"]').val());
    });
