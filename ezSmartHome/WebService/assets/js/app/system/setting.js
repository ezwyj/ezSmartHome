define(['common', 'util', 'template', 'plugins'], function ($, util, template) {
    ...
    $('#add-value').on('click', function () {
        ...
        $.content({
            ...
            footer: [{
                ...
                text: '确定',
                callback: function () {
                    if( $('[name="Value"]', this).val()==""){
                        $.tips('未输入值', 2);
                        return false;
                    }
                    if ($('[name="Text"]', this).val()=="")
                    {
                        $.tips('未输入文本', 2);
                        return false;
                    }
                ...
                $.content({
                    ...
                    footer: [{
                        ...
                        callback: function () {
                            ...
                            if ($.trim($('[name="Value"]', this).val()) == '') {
                                $.tips('请填写值内容！', 0);
                                return false;
                            }
                            if ($.trim($('[name="Text"]', this).val()) == '') {
                                $.tips('请填写文本内容！', 0);
                                return false;
                            }
    ...
    var rightTable = $('#userRightList').table({
        ...
        data: function () {
            return {
                rightUser: $('#searchRight').val().replace("'","")
            };
        },
        resizable: false,
        checkbox: true,
